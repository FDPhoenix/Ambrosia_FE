...
function DishMenu() {
  ...
  return (
    <div className="w-full min-h-[790px] bg-[#ddd] px-4 lg:px-16 pt-16 pb-10 lg:pb-12 xl:bg-[#A2845E]">
      <div className="w-full flex flex-col md:flex-row md:justify-between md:gap-10">
        ...
        <div className="hidden xl:block w-1/4 order-2 md:order-1">
          ...
          <div className="border border-[#d69c52] rounded mb-8">
            ...
            <form className="w-full">
              <div className="flex py-4 px-5 border-t border-[#d69c52]">
                <input type="checkbox" id="first" name="price" value="above-1000000" className="mr-2" />
                <label htmlFor="first" className="text-[19px] text-[#00405d]">Above 1.000.000₫</label>
              </div>

              <div className="flex py-4 px-5 border-t border-[#d69c52]">
                <input type="checkbox" id="second" name="price" value="500000-1000000" className="mr-2" />
                <label htmlFor="second" className="text-[19px] text-[#00405d]">500.000 - 1.000.000₫</label>
              </div>

              <div className="flex py-4 px-5 border-t border-[#d69c52]">
                <input type="checkbox" id="third" name="price" value="200000-500000" className="mr-2" />
                <label htmlFor="third" className="text-[19px] text-[#00405d]">200.000 - 500.000₫</label>
              </div>

              <div className="flex py-4 px-5 border-t border-[#d69c52]">
                <input type="checkbox" id="fourth" name="price" value="100000-200000" className="mr-2" />
                <label htmlFor="fourth" className="text-[19px] text-[#00405d]">100.000 - 200.000₫</label>
              </div>

              <div className="flex py-4 px-5 border-t border-[#d69c52]">
                <input type="checkbox" id="fifth" name="price" value="below-100000" className="mr-2" />
                <label htmlFor="fifth" className="text-[19px] text-[#00405d]">Below 100.000₫</label>
              </div>
            </form>
          </div>
        </div>
        ...
        <div className="w-full mt-9 md:mt-0 xl:w-3/4 xl:mt-0 order-1 xl:order-2">
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="w-full md:w-full flex justify-center md:float-right gap-4 order-3">
              <button
