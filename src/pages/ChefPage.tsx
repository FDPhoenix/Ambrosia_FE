...
function ChefPage() {
    ...
    return token && decodedToken?.roleId?.includes("67ac667ae072694cafa16e7c") ? (
                    ...
                    <div className="p-6">
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-[16px]">
                                ...
                                {[{ path: "/chef/order", icon: OrderIcon, label: "Order" }, { path: "/chef/feedback", icon: FeedbackIcon, label: "Feedback" }, { path: "/chef/ingredient", icon: IngredientIcon, label: "Ingredient" }].map(({ path, icon, label }) => (
                                    <li key={path}>
                                        <button
                                            onClick={() => {
                                                navigate(path);
