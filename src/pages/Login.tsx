        ...
        if (Array.isArray(decodedToken.roleId)) {
          for (const roleId of decodedToken.roleId) {
            if (roleMap[roleId]) {
              ...
              break; // ưu tiên theo thứ tự role đầu tiên tìm thấy
            }
          }
        ...
        <>
          ...
          <div className="flex justify-center items-center mb-6 space-x-4">
            <a href="/" onClick={(e) => { e.preventDefault(); navigate("/"); }}>
              <img src={logo} alt="Ambrosia Logo" className="w-[4rem] h-[4rem] rounded-full border-4  border-[#a68a64] shadow-lg object-cover" />
            </a>
            <h1 className="text-3xl font-bold text-[#a68a64] font-serif">Ambrosia</h1>
          </div>
